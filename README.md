...
secure mock quote delivery, audit events and a protected Jobs dashboard. Customer verification,
acceptance and the remaining vertical slice are outside the current implementation.
